...
<body class="bg-light">
    ...
    <!-- Pindahkan semua script ke bawah sebelum </body> -->
    ...
    <script>
        ...
        // Sweet Alert Delete Confirmation (event delegation)
        $(document).on('click', '.delete-blog', function(e) {
            e.preventDefault();
            console.log('Tombol delete diklik'); // Debug log
            const blogId = $(this).data('id');
            // Hilangkan tag HTML dari title
            const blogTitle = $('<div>').html($(this).data('title')).text();
